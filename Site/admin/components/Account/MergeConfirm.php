...
abstract class SiteAccountMergeConfirm extends AdminDBConfirmation
{
    ...
    protected function processDBData()
    {
        ...
        $message = new SwatMessage(
            sprintf(
                Site::_('Successfully merged the account “%s” into “%s”.'),
    ...
    protected function buildInternal()
    {
        ...
        echo '<h3>';
        printf(
            Site::_('Are you sure you want to merge the account %s into %s?'),
        ...
        $this->ui->getWidget('yes_button')->title = Site::_('Merge Accounts');
    }

...
class SiteResetPasswordMailMessage extends SiteMultipartMailMessage
{
    ...
    public function send()
    {
        if ($this->account->email == '') {
            throw new SiteException(
                'Account requires an email address to ' .
    ...
    protected function getFormattedBody($format_string, $formatted_link)
    {
        return sprintf(
            ...
            sprintf(
                Site::_(
                    'This email is in response to your recent ' .
            ...
            $formatted_link,
            Site::_(
                'Clicking on this link will take you to a page that ' .
            ...
            Site::_(
                'When someone forgets their password the best way ' .
            ...
            sprintf(
                Site::_(
                    'If you did not request a new password from %s ' .
